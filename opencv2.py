...
cascade_filename = 'D:/opencv/haarcascade_frontalface_alt.xml'
# 모델 불러오기
...
age_net = cv2.dnn.readNetFromCaffe(
	'D:/opencv/FACENET_WEIGHT/deploy_age.prototxt',
	'D:/opencv/FACENET_WEIGHT/age_net.caffemodel')

gender_net = cv2.dnn.readNetFromCaffe(
	'D:/opencv/FACENET_WEIGHT/deploy_gender.prototxt',
	'D:/opencv/FACENET_WEIGHT/gender_net.caffemodel')
...
# 이미지 파일
img = cv2.imread('D:/opencv/love.jpg')
